<?php
  ...
  if (!empty($_POST['id']) && !empty($_POST['nombre']) && !empty($_POST['direccion']) && !empty($_POST['descripcion'])) {
    $sql = "UPDATE Acambaro set nombre='$_POST[nombre]', direccion='$_POST[direccion]', descripcion='$_POST[descripcion]'  where id='$_POST[id]'";
        ...
        <div class="d-flex justify-content-center h-100">
            <div class="card card-login">
                <div class="card-header text-center">
                    <h3>Editar Acambaro</h3>
                </div>
                <div class="card-body">
                    <form action="editarAcambaro.php" method="post"> 
