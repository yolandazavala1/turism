<?php
  ...
  if (!empty($_POST['id']) && !empty($_POST['nombre']) && !empty($_POST['direccion']) && !empty($_POST['descripcion'])) {
    $sql = "UPDATE Moroleon set nombre='$_POST[nombre]', direccion='$_POST[direccion]', descripcion='$_POST[descripcion]'  where id='$_POST[id]'";
    ...
    <?php if($user['admin']==1): ?>
        ...
        <div class="d-flex justify-content-center h-100">
            <div class="card card-login">
                ...
                <div class="card-body">
                    <form action="editarMoroleon.php" method="post"> 
